              ...
              if ($hasil['tahap'] == 0 || $hasil['tahap'] == 2) : ?>                
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-11 col-md-offset-1"> 
                     ...
                     <div class="pull-left info">
                      <label for="dp" style="margin-left: 15px; color:#0081d8; font-size: 1.3em; margin-bottom: 1px;"> Dosen Pembimbing Akademik</label>
                      <br>
                      <select name="dp" class="form-control select2" data-placeholder="Pilih Dosen Pembimbing Akademik" required>
                                <option>
                          <?php 
                    ...
                    <div class="form-group" style="margin-bottom: 2px;">
                     ...
                     <div class="pull-left info">
                      <label for="file1" style="margin-left: 15px; color:#0081d8; font-size: 1.5em; margin-bottom: 1px;"> Transkip Nilai </label>
                      <P style="margin-left: 15px; color:black; font-size: 0.9em; margin-bottom: 4px;">Scan Transkip nilai yang sudah di Paraf pemegang SKS dalam bentuk.PDF</P>
                     ...
                     <div class="pull-left info" style="color: black;">
                      ...
                      <P style="margin-left: 15px; color:black; font-size: 0.9em; margin-bottom: 4px;">Scan Sertifikat Toefl bahasa inggris/Sertifikat UEPT dalam bentuk.PDF</P>
                     ...
                     <div class="pull-left info" style="color: black;">
                      ...
                      <P style="margin-left: 15px; color:black; font-size: 0.9em; margin-bottom: 4px;">Scan Lembar Ringkasan dan Summary dalam bentuk.PDF</P>
                     ...
                     <div class="pull-left info" style="color: black;">
                      ...
                      <P style="margin-left: 15px; color:black; font-size: 0.9em; margin-bottom: 4px;">Scan Draf Skripsi yang sudah ditandatangani pembimbing skripsi dalam bentuk.PDF</P>
                     ...
                     <div class="pull-left info" style="color: black;">
                      ...
                      <P style="margin-left: 15px; color:black; font-size: 0.9em; margin-bottom: 4px;">Scan Data Alumni Mahasiswa dalam bentuk.PDF</P>
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="box-body">
                  <div class="col-md-11 col-md-offset-2"> 
                    <?php 
              $a = "SELECT *, tb_dsn.nama AS nama_dosen FROM tb_mhs JOIN tb_dsn ON tb_mhs.dosen_pembimbing = tb_dsn.id_dosen WHERE tb_mhs.id_mahasiswa = $user ";
              ...
              ?>
                    <div class="form-group" style="margin-bottom: 2px;">
                      <div class="user-panel" style="padding: 0 0 010px; display: block; height: 75px;">
                        ...
                        <div class="pull-left info">
                          <label for="file" style="margin-left: 15px; color:#0081d8; font-size: 1.3em; margin-bottom: 1px;"> Dosen Pembimbing Akademik </label><br>
                          <span style="color : black; margin-left: 15px;"> <?= $c['nama_dosen']; ?> </span>
              ...
              ?>
                    <div class="form-group" style="margin-bottom: 2px;">
                      <div class="user-panel" style="padding: 0 0 010px; display: block; height: 75px;">
                        ...
                        <div class="pull-left info">
                          <label for="file" style="margin-left: 15px; color:#0081d8; font-size: 1.3em; margin-bottom: 1px;"> Dosen Pembimbing Skripsi 1 </label><br>
                          <span style="color : black; margin-left: 15px;"> <?= $c['nama_dosen']; ?> </span>
              ...
              ?>
                    <div class="form-group" style="margin-bottom: 2px;">
                      <div class="user-panel" style="padding: 0 0 010px; display: block; height: 75px;">
                        ...
                        <div class="pull-left info">
                          <label for="file" style="margin-left: 15px; color:#0081d8; font-size: 1.3em; margin-bottom: 1px;"> Dosen Pembimbing Skripsi 2 </label><br>
                          <span style="color : black; margin-left: 15px;"> <?= $c['nama_dosen']; ?> </span>
                 ...
                 <div class="pull-left info" style="color: black;">
                  <label for="file" style="margin-left: 15px; color:#0081d8; font-size: 1.3em; margin-bottom: 0px;"> Draf Skripsi </label><br>
                    <a class="btn btn-default" target="_blank" href="uploads/<?php echo $hasil['file4']?>" style="color:black; margin-left: 15px;">Download</a>
                 </div>
                 </div>
                 </div>
                 <div class="form-group">
                  <div class="user-panel" style="padding: 0 0 010px; display: block; height: 75px;" >
                   <div class="pull-left image">
                  <img style="max-width: 68px;" src="../../../dist/img/Capture.png" class="img-circle" alt="User Image">
                   </div>
                 <div class="pull-left info" style="color: black;">
                  <label for="file" style="margin-left: 15px; color:#0081d8; font-size: 1.3em; margin-bottom: 0px;"> Data Alumni  </label><br>
                    <a class="btn btn-default" target="_blank" href="uploads/<?php echo $hasil['file5']?>" style="color:black; margin-left: 15px;">Download</a>
                 </div>
                 </div>
                 </div>
                </div>
