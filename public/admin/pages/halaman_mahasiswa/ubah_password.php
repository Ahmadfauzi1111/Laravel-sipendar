...
$ahfa = $_SESSION['iduser'];
        $sql = mysqli_query($conn,"SELECT * FROM tb_mhs WHERE id_mahasiswa = '$ahfa'");
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="pendaftaran_pendadaran/pendaftaran.php">
            <i class="fa fa-automobile "></i> <span>Pendaftaran Pendaran</span>
         ...
         <li>
          <a href="penjadwalan/penjadwalan_pendadaran.php">
            <i class="fa fa-dashboard"></i> <span>Jadwal Pendadaran</span>
           <!--  <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span> -->
          </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="datapustaka.php">Pengaturan Akun</a></li>
