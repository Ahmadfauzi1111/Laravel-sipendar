...
if (isset($_POST['simpan'])) {
  ...
  $sqll ="INSERT INTO tb_kms VALUES ('','', '$nama', '$nip', '$tanggal_lahir', '$jenis_kelamin', '$alamat', '$user')";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="data_komisi.php">Data Komisi</a></li>
        <li class="active">Tambah Komisi</li>
      </ol>
    </section>
    <?php 
    $query = mysqli_query($conn,"SELECT * FROM tb_dsn");
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-12">
           ...
           <div class="col-xs-12 text-center">
                    <a href="data_komisi.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Data Komisi</a>
