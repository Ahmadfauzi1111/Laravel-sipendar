...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
      ...
      <div class="row">
        <?php
          $sql = mysqli_query($conn,"SELECT * FROM tb_kms WHERE id_komisi = '$id'");
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Perbarui Komisi</h3>
              </div>
              <!-- /.box-header -->
                <div class="box-body">
                  <div class="col-xs-12">
                    <input type="hidden" name="id" value="<?php echo $row['id_komisi'] ?>">
          ...
          <div class="col-xs-12 text-center">
            <a href="data_komisi.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Data Admin</a>
