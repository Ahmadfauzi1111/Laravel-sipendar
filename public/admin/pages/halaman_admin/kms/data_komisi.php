...
$ahfa = $_SESSION['iduser'];
        $sql = mysqli_query($conn,"SELECT * FROM tb_adm WHERE id_admin = '$ahfa'");
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="../adm/data_admin.php">
            ...
            <!-- <span class="pull-right-container">f
              <small class="label pull-right bg-green">new</small>
            </span> -->
          </a>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="buat_data.php" class="btn btn bg-blue margin margin-bottom" style="margin-right: 20px;"><i class="fa fa-user-plus"></i> Tambah Komisi</a>
          <!-- /.box -->
          <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h4 class="box-title">Komisi Fakultas Biologi</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <div style="text-align: center;">
                    <a href="informasi.php?id=<?php echo $row['id_komisi'] ?>" class="btn btn-info btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-eye"></i></a>
                     <a href="perbarui.php?id=<?php echo $row['id_komisi'] ?>" class="btn btn-default btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-pencil"></i></a>
                    <a href="hapus.php?id=<?php echo $row['id_komisi']?>" class="btn btn-danger btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-trash"></i></a>
                  </div>
                </td>
                </tr>
              <?php 
