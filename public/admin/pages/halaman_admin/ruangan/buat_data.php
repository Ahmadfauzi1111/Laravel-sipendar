...
if (isset($_POST['simpan'])) {
  ...
  mysqli_query( $conn, "INSERT INTO tb_ruangan VALUES ('','$nama')" );
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="data_dosen.php">Data Ruangan</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-12">
           ...
           <div class="col-xs-12 text-center">
                    <a href="data_dosen.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Data Ruangan</a>
