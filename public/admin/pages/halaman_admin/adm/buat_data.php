...
if (isset($_POST['simpan'])) {
  ...
  mysqli_query( $conn, "INSERT INTO tb_adm VALUES ('', '$nama', '$nip', '$tanggal_lahir', '$jenis_kelamin', '$alamat', '$user')" );
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-12">
           ...
           <div class="col-xs-12 text-center">
                    <a href="data_admin.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Data Admin</a>
