...
if (isset($_POST['simpan'])) {
  ...
  $sql = "INSERT INTO user_level VALUES ('','$username','$password','$level')";
  mysqli_query( $conn, $sql);
  $user = mysqli_insert_id ($conn); 
  
  $status ='gagal';

  mysqli_query( $conn, "INSERT INTO tb_mhs VALUES ('','','$nama','$nim','$angkatan','$tanggal_lahir','$jenis_kelamin','$alamat','','','','','','','','','$user','0')" ) or die(mysqli_error($conn));
        ...
        <div class="col-xs-12">
          ...
          <div class="col-md-12">
              ...
              <!-- /.box-header -->
                <div class="box-body">
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Angkatan</label>
                      <div class="col-xs-3">
                        <input type="text" class="form-control" id="angkatan" name="angkatan" placeholder="Enter Angkatan" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Tanggal Lahir</label>
                      <div class="col-xs-3">
                        <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" placeholder="Enter Tanggal Lahir" required>
                      </div>
                    </div>
                    <div class="form-group">
           ...
           <div class="col-xs-12 text-center">
                    <a href="data_mahasiswa.php" class="btn btn-default" style="margin-right: 20px;">Kembali ke Data Mahasiswa</a>
