          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Perbarui Mahasiswa</h3>
              </div>
              <!-- /.box-header -->
                <div class="box-body">
                  <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-10">
                        <input value="<?php echo $row['nim'] ?>" type="text" class="form-control" id="nim" name="nim" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="" class="col-sm-2 control-label">Angkatan</label>
                      <div class="col-xs-10">
                        <input value="<?php echo $row['angkatan'] ?>" type="text" class="form-control" id="angkatan" name="angkatan" required>
                      </div>
                    </div>
                    <div class="form-group">
