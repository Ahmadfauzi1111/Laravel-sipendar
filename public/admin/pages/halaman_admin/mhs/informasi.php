    ...
    <!-- Main content -->
      ...
      <div class="row no-print">
        <div class="col-xs-12 text-center">
          <a href="data_mahasiswa.php" class="btn btn-default" style="margin-right: 10px;">Kembali</a>
          <a href="hapus.php?id=<?php echo $row['id_mahasiswa']; ?>)" class="btn btn-danger">Hapus</a>
        </div>
      </div>
      <!-- /.row -->
