...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <a href="buat_data.php" class="btn btn bg-blue margin margin-bottom" style="margin-right: 20px;"><i class="fa fa-user-plus"></i> Tambah Dosen Penguji</a>
          <!-- /.box -->
           <div class="box">
            <div class="box-header">
             <h4 class="box-title">Dosen Penguji Fakultas Biologi</h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                // Ambil Data
                 ...
                 <tr>
                  ...
                  <div style="text-align: center;">
                     <a href="informasi.php?id=<?php echo $row['id_dosen'] ?>" class="btn btn-info btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-eye"></i></a>
                     <a href="perbarui.php?id=<?php echo $row['id_dosen'] ?>" class="btn btn-default btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-pencil"></i></a>
                    <a href="hapus.php?id=<?php echo $row['id_dosen']?>" class="btn btn-danger btn-xs btn-flat" style="margin: 0 5px 0 0;"><i class="fa fa-trash"></i></a>
                  </div>
                </td>
                </tr>
              <?php 
