...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
        $sq = mysqli_query($conn,"SELECT count(*) as jumlah FROM tb_mhs WHERE tahap=4");
        $abc = mysqli_fetch_assoc($sq);
       ?>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Mahasiswa <p>Sudah Pendadaran</p></span>
              <span class="info-box-number"><?php echo $abc['jumlah']; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <!-- ./col -->
        <?php 
        $dosen = mysqli_query($conn,"SELECT count(*) as max FROM tb_dsn");
        $jumlah = mysqli_fetch_assoc($dosen);
         ?>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $jumlah['max']; ?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <section class="col-lg-12 ">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Mahasiswa yang telah Pendadaran</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $nomor = 1;
                // Ambil Data
                 $lulus = 'SELECT * FROM tb_mhs WHERE tahap=4';
                 // mysql_select_db('test_db');
                 $retval = mysqli_query( $conn, $lulus);
