...
<h3 style="margin-bottom:0px;">Mahasiswa yang Gagal pendadaran</h3>
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            {{-- </div> --}}
            <div class="col-sm-6">
                <form action="/halaman_komisi/gagal" method="GET">
                    <ol class="breadcrumb">
                        <li>
...
<div class="table-responsive-md">
    <table id="example1" class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            @endphp
            @if ($value->tahap == 7 && $semuaDosen && $nilaiTotal <60)
            <tr>
                <th>@php
                    echo $a = $a+1;
                    @endphp</th>
                ...
                {{-- <td style="text-align: center"><a href="/halaman_komisi/laporangagal/{{$value->id_mahasiswa}}"
