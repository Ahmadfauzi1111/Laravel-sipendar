                        ...
                        <div class="modal-dialog" role="document" style="max-width:900px;">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-borderless">
                                        <thead>
                                            ...
                                            <td><a target="_blank" href="/halaman_komisi/pengajuan/download/file1/{{ $mahasiswa->id_mahasiswa }}" class="btn-xs btn-primary">Lihat Data</a></td>
                                            </tr>
                                            <tr>
                                                <th scope="col">Transkip Nilai</th>
                                                <th>:</th>
                                                <td>{{ $mahasiswa->file2 }}</td>
                                            <td><a target="_blank" href="/halaman_komisi/pengajuan/download/file2/{{ $mahasiswa->id_mahasiswa }}" class="btn-xs btn-primary">Lihat Data</a></td>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                                ...
                                <div class="modal-footer justify-content-center">
                                    <form action="/halaman_komisi/pengajuan/{{$mahasiswa->id_mahasiswa}}"
                                        ...
                                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" 
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content bg-danger">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Belum Memenuhi dengan Alasan</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                        </div>
