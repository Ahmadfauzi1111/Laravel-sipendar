...
<br>
    ...
    <table style="margin-left: 70px; line-height: 65%; font-size:14px;">
        <tr>
            ...
            <td>
                @foreach ($mahasiswa as $faker)
                    @if($faker->id_mahasiswa == $jadwal->id_mhs)
                {{ $faker->nim }}
                    @endif
                @endforeach
            </td>
        ...
        <tr>
            ...
            <td>
                @foreach ($dosen as $faker)
                    ...
                    <br>
                    <span style="margin-left:60; font-size:13px;">{{ $faker->nip }}</span>
                    <br>
                    @endif
                @endforeach
            </td>
        ...
        <tr>
            ...
            <td>
                @foreach ($dosen as $faker)
                    @if($faker->id_dosen == $jadwal->id_dsn2)
                    <img src="data:image/png;base64, {{DNS1D::getBarcodePNG($faker->nip, 'C128', 2,28,array(1,1,1)) }} "/>
                    <br><span style="margin-left:60; font-size:13px;">{{ $faker->nip }}</span>
                    @endif
                @endforeach
            </td>
        </tr>
